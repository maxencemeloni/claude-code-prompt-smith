...
**Load rules first:** Use the `Read` tool to read `${CLAUDE_PLUGIN_ROOT}/PROMPT_SMITH.md`. This file contains your optimization philosophy and mode definitions — you MUST use them. If the file cannot be found, warn the user: "Could not load PROMPT_SMITH.md — reinstall the plugin." and continue with best judgment.
